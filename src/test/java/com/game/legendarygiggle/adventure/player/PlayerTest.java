package com.game.legendarygiggle.adventure.player;

import com.game.legendarygiggle.adventure.map.Position;
...
public class PlayerTest {
    ...
    public void testGetAndSetPlayerCurrentPosition() {
        ...
        MatcherAssert.assertThat("should update the player position",
